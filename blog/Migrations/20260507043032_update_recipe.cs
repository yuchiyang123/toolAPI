...
namespace blog.Migrations
{
    ...
    public partial class update_recipe : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IngredientsGroupName = table.Column<string>(
                        type: "nvarchar(200)",
                        maxLength: 200,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IngredientsName = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "RecipeDetailMapping");

            migrationBuilder.DropTable(name: "RecipeIngredientsDetailMapping");

            migrationBuilder.DropTable(name: "RecipeIngredientsMapping");

            migrationBuilder.DropTable(name: "RecipeStepMapping");

            migrationBuilder.DropTable(name: "RecipeTagMapping");

            migrationBuilder.DropTable(name: "RecipeDetail");

            migrationBuilder.DropTable(name: "RecipeIngredientsDetail");
